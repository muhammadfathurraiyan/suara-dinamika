    ...
    <>
      ...
      <div className="flex mt-2">
        <button
          ...
          } py-2 px-8 bg-neutral-900 hover:bg-neutral-900/90 duration-300 uppercase w-fit text-neutral-50`}
        >
          Submit
        </button>
      </div>
...
export function InsertImageDialog({
  ...
  return (
    <>
      {!mode && (
        <div className="flex w-full justify-center items-center flex-col mt-5 gap-2">
          <button
            className={`py-2 px-8 bg-neutral-900 cursor-pointer hover:bg-neutral-900/90 duration-300 uppercase w-fit text-neutral-50`}
